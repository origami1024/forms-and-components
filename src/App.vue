<template>
  <div id="app">
    <Group title="Standart buttons">
      <div class="row">
        <Btn bgc="#4EB7A8" bgcl="#28A290" :small="true"></Btn>
        <Btn bgc="#4EB7A8" bgcl="#28A290"></Btn>
        <Btn bgc="#E75735" bgcl="#BF3E1F"></Btn>
        <Btn bgc="#E75735" bgcl="#BF3E1F" :small="true"></Btn>
      </div>
    </Group>
    ...
    <Group title="Sliders">
      <div class="row">
        <Slider :width="100" :val.sync="slider1value" :showGrad="false" />
        <Slider :showPop="false" :showRuler="true" bgc="#4EB7A8" :width="100" :val.sync="slider2value" :maxval="100" :second="true"/>
      </div>
    </Group>
    <Group title="Stages">
    ...
    <Group title="Form Elements">
      <div class="row">
        ...
        <div class="col">
          <Group title="Toggles">
            <div class="row">
              <Toggle class="comp-outer" bgc="#4EB7A8" :value.sync="toggleState1"/>
              <Toggle class="comp-outer" bgc="#4EB7A8" :value.sync="toggleState2"/>
            </div>
          </Group>
...
import ArrBtn from './components/ArrBtn.vue'
  ...
  data: function() {
    return {
      ...
      calendar: {
        ...
        img: require('./assets/img/calendar1.png'),
        alt: 'grayscale photo of adverticing on a pack of closely grouped skyskrappers from a street underneath them',
      ...
      news: {
        ...
        img: require('./assets/img/event1.png'),
        alt: 'man on a sport bike going moving down a hill, blue sky behind',
